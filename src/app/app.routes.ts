...
import {SignInGuard} from './components/guards/sign-in.guard';

export const routes: Routes = [
  { path: '', component: HomeComponent },
  { path: 'login', loadComponent: () => import('./components/form/sign-in.component').then(m => m.SignInComponent), canActivate: [SignInGuard] },
